        ...
        {items.length > 0 && (
          <div className="border-t px-6 py-4 space-y-3">
            ...
            <button
              ...
              className="flex items-center justify-center gap-2.5 w-full bg-[#25D366] text-white py-3 rounded-full font-semibold hover:bg-[#1ebe5d] transition shadow-sm"
            >
              {/* WhatsApp icon */}
