...
export async function generateStaticParams() {
  const res = await getProducts().catch(() => ({ data: [] }));
      ...
      <div className="border-b" style={{ borderColor: "#e4ddd2" }}>
        <div className="max-w-7xl mx-auto px-5 lg:px-8 py-3.5">
          ...
          >
            <Link
              href="/"
              className="hover:text-[#1e2a1a] transition-colors"
            >
              Home
            </Link>
            <span>/</span>
          ...
          <div className="flex flex-col">
                ...
                >
                  ...
                  <div>
                    ...
                    <p
                      ...
                      style={{ color: "#6b6355" }}
                    >
                      Pricing for this product varies based on quantity
                      and season. Contact us for a quote.
                    </p>
                  </div>
                </div>
              ) : (
            ...
            >
              {product.shortDescription ||
                "Premium quality dried vegetable, naturally processed and carefully packed to preserve nutrients and flavor."}
            </p>
            ...
            {/* Meta Info */}
            <div
              className="flex flex-wrap gap-x-5 gap-y-2 mt-6 pt-6"
